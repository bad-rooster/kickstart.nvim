...
-- Reload files changed outside nvim (e.g. by Claude Code)
...
require('lazy').setup({
  ...
  { 'NMAC427/guess-indent.nvim', pin = true }, -- Detect tabstop and shiftwidth automatically
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', function()
        builtin.live_grep { glob_pattern = { '!plans/**', '!docs/**', '!*.md' } }
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascript = { 'prettierd', 'prettier', stop_after_first = true, 'eslint_d' },
        html = { 'prettier' },
        json = { 'prettier' },
        yaml = { 'prettier' },
        markdown = { 'prettier' },
